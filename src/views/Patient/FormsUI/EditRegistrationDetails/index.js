...
import { Spin, Skeleton, Button, Col, Form, Input, InputNumber, Row, Select, DatePicker, Divider, notification } from 'antd';
...
const EditRegistration = () => {
  ...
  const handleCountryChange = (newCountry) => {
    ...
    if (!newCountry) {
      ...
      const statesForCountry = patientDropdown.States.filter((state) => state.CountryId === newCountry);
  ...
  const handleStateChange = (newState) => {
    ...
    if (!newState) {
      ...
      const citiesForState = patientDropdown.Places.filter((city) => city.StateId === newState);
  ...
  const handleCityChange = (newCity) => {
    ...
    if (!newCity) {
      ...
      // Filter cities based on the selected state
      const areasForCities = patientDropdown.Areas.filter((area) => area.PlaceId === newCity);
              ...
              <Row gutter={20}>
                <Col span={18}>
                  ...
                  <Row gutter={16}>
                    ...
                    <Col span={7}>
                      <Form.Item name="MaritalStatus" label="Patient Marital Status">
                        <Select allowClear>
                ...
                <Col span={6} style={{ overflow: 'hidden', paddingRight: '10px' }}>
              ...
              <Row gutter={14}>
                ...
                <Col span={4}>
                  <Form.Item name="city" label="City">
                    <Select value={selectedCity || ''} onChange={handleCityChange} allowClear>
                ...
                <Col span={4}>
                  <Form.Item name="area" label="Area">
                    <Select value={selectedArea || ''} onChange={(value) => setSelectedArea(value)} allowClear>
